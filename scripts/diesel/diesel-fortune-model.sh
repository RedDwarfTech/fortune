...
--import-types "crate::model::diesel::fortune::fortune_schema::*" \
--schema-file "${PROJECT_DIR}"/src/model/diesel/fortune/fortune_schema.rs --model > "${PROJECT_DIR}"/src/model/diesel/fortune/fortune_models.rs
